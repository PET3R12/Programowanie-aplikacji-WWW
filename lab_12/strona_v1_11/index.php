...
<body class="home" onload="startclock()">
  ...
  <header class="site-header" role="banner">
    <div class="header-inner">
      ...
      <nav aria-label="Główne menu" class="main-nav" role="navigation">
        ...
        <a href="index.php?idp=sklep"><b>SKLEP</b></a>
  ...
  <main class="container" role="main">
    <?php
      // Jeśli idp to 'sklep', załaduj moduł sklepu
      if (isset($_GET['idp']) && $_GET['idp'] == 'sklep') {
          include('koszyk.php'); // Dołączenie logiki koszyka
          PokazKoszyk();         // Wyświetlenie koszyka na górze
          echo '<hr>';
          PokazProduktySklep();  // Wyświetlenie listy produktów
      } 
      // W przeciwnym razie działaj jak zwykły CMS
      else {
